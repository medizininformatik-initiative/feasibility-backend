...
public class DSFQueryResultCollectorIT {
    ...
    private static final String SINGLE_DIC_RESULT_PROFILE = "http://medizininformatik-initiative.de/fhir/StructureDefinition/codex-task-single-dic-result-simple-feasibility|0.2.0";
    ...
    private Task createTestTask(String brokerQueryId, String siteId, String measureReportReference, String profile) {
        Task task = new Task()
                ...
                .setInstantiatesUri("http://highmed.org/bpe/Process/requestSimpleFeasibility/0.2.0");
