...
public class DSFQueryResultCollectorIT {
    ...
    private static final String SINGLE_DIC_RESULT_PROFILE = "http://medizininformatik-initiative.de/fhir/StructureDefinition/feasibility-task-single-dic-result|0.2.0";
    ...
    private Task createTestTask(String brokerQueryId, String siteId, String measureReportReference, String profile) {
        Task task = new Task()
                ...
                .setInstantiatesUri("http://highmed.org/bpe/Process/feasibilityRequest/0.2.0");
